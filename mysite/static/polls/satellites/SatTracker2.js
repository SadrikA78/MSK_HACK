...
wwd.navigator.lookAtLocation.latitude = 40.0977;
wwd.navigator.lookAtLocation.longitude = 80.0119;
...
// Create the path's positions.
        ...
        pathPositions.push(new WorldWind.Position(45, -110, 1e6));
...
// Create a layer to hold the polygons.
        ...
        boundaries[0].push(new WorldWind.Position(40, 10, 1e6));
		boundaries[0].push(new WorldWind.Position(80, 15, 2000000));
        
		boundaries[0].push(new WorldWind.Position(60, 30, 1e5));
		boundaries[0].push(new WorldWind.Position(60, 30, 1e5));
...
//______________________________
        ...
        boundaries[0].push(new WorldWind.Position(60, 30, 1e5));
		boundaries[0].push(new WorldWind.Position(60, 30, 1e5));
		boundaries[0].push(new WorldWind.Position(20, 40, 1e6));
		boundaries[0].push(new WorldWind.Position(60, 60, 1e6));
...
//retrieves TLE data
var grndStationsWorker = new Worker("static/polls/satellites/Workers/groundStationsWorker.js");
...
function getGroundStations(groundStations) {
  var satParserWorker = new Worker("static/polls/satellites/Workers/satelliteParseWorker.js");
