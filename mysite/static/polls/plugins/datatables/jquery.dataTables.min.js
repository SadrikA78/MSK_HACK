...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": активировать для сортировки столбца по возрастанию",sSortDescending:": активировать для сортировки столбца по убыванию"},oPaginate:{sFirst:"Первая",sLast:"Последняя",sNext:"Следующая",sPrevious:"Предыдущая"},sEmptyTable:"Данные отсутствуют в таблице",sInfo:"Отображено с _START_ по _END_ из _TOTAL_ записей",sInfoEmpty:"Показано с 0 по 0 из 0 записей",sInfoFiltered:"(отфильтровано _MAX_ записей)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Показывать _MENU_ записей",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Совпадающих записей не найдено"},oSearch:h.extend({},n.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};$(n.defaults);n.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc",
